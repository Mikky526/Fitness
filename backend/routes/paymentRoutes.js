...
const { processDummyPayment, getMyPayments, getAllPayments, getPurchaseStatus } = require('../controllers/paymentController');
...
router.get('/status',   protect, authorizeRoles('user'), getPurchaseStatus);
